            ...
            >
              ...
              <div className="mt-3 grid grid-cols-[1fr_auto] gap-2">
                <button
                  ...
                  className="rounded-pill bg-accent px-4 py-2.5 text-sm font-medium text-text disabled:opacity-40"
                >
                  Use {profile.label}
                </button>
                <button
      ...
      <section aria-labelledby="create-test-profile">
        ...
        <div className="flex flex-col gap-5 rounded-card bg-surface/60 p-4 ring-1 ring-white/[0.06] ring-inset">
          ...
          <button
            type="button"
            onClick={addProfile}
            className="w-full rounded-pill bg-accent px-5 py-3.5 text-sm font-medium text-text transition-opacity hover:opacity-90"
          >
            Save test profile
          </button>
        </div>
